                ...
                <div className={resetCSS.body}>
                    <div className={resetCSS.form-container}>
                        <Form className={`form mx-auto bg-white ${resetCSS.form}`}>
                            <h5 className={`form-title ${resetCSS.form-title}`}>Reset Password</h5>
                            <div>
                                <span>
                            ...
                            <div className={`form-floating email-form ${resetCSS.email-form}`}>
                            ...
                            <Button classname={`resetPassword btn btn-outline-danger reset-button ${resetCSS.reset-button}`} variant="outline-danger" type="reset">Reset Password</Button>
                        </Form>

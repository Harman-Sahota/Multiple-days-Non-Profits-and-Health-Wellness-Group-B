...
|9| Project Change <br/> Begin coding homepage, login, and registration pages <br/> Create Gantt Chart| [Client Meeting Minutes (Oct. 31)](docs/client-minutes/client-meeting-oct31-1230pm.md) <br/> [Client Meeting Minutes (Nov. 3)](docs/client-minutes/client-meeting-nov3-11am.md) <br/> [Team Meeting Minutes (Nov. 4)](docs/team-minutes/minutes_nov4.md)|
